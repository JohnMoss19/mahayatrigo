...
export default function HotelPartners() {
  ...
  return (
    <section className="py-24 bg-white border-y border-gray-100 overflow-hidden relative transform-gpu">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0" aria-hidden="true">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[radial-gradient(circle,var(--color-primary)_0%,transparent_70%)] opacity-10 animate-blob" />
      </div>
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          <FadeIn direction="right" className="text-center lg:text-left max-w-xl">
            ...
            <p className="text-gray-500 text-fluid-p font-light leading-relaxed max-w-md mx-auto lg:mx-0">
          ...
          <FadeIn direction="left" className="flex flex-col items-center lg:items-end group">
            <div className="relative p-10 md:p-16 rounded-[3rem] bg-white border border-gray-100 group-hover:shadow-2xl transition-all duration-700">
